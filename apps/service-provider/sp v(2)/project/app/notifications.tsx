...
const mockNotifications = [
  {
    ...
    message: 'Your plumbing service booking has been confirmed for today at 2:00 PM',
    type: 'booking',
    read: false,
    timestamp: '1 min ago',
    icon: CheckCircle,
  ...
  // Example commented-out item (optional)
  // {
  //   id: 2,
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 20, fontWeight: '700', color: '#19034d' },
  unreadBadge: {
  ...
  markAllText: { fontSize: 12, fontWeight: '600', color: '#19034d' },
  notificationsList: { flex: 1, paddingHorizontal: 24 },
  notificationCard: {
  ...
  unreadCard: { backgroundColor: '#f0fff1', borderWidth: 1, borderColor: '#05f51d' },
  notificationContent: { flexDirection: 'row', alignItems: 'flex-start', flex: 1, gap: 12 },
  iconContainer: { width: 40, height: 40, borderRadius: 20, justifyContent: 'center', alignItems: 'center' },
  textContent: { flex: 1 },
  notificationTitle: { fontSize: 16, fontWeight: '500', color: '#19034d', marginBottom: 4 },
  unreadTitle: { fontWeight: '600' },
  notificationMessage: { fontSize: 14, color: '#666', lineHeight: 20, marginBottom: 8 },
  timestamp: { fontSize: 12, color: '#999' },
  unreadDot: { width: 8, height: 8, backgroundColor: '#05f51d', borderRadius: 4, marginTop: 4 },
  deleteButton: { padding: 8 },
  emptyState: { flex: 1, justifyContent: 'center', alignItems: 'center', paddingVertical: 80 },
  emptyStateTitle: { fontSize: 18, fontWeight: '600', color: '#19034d', marginTop: 16, marginBottom: 8 },
