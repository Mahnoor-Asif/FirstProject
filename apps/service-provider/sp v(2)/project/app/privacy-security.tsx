        ...
        {activeTab === 'terms' ? (
          <>
            ...
            <View style={styles.section}>
              ...
              <Text style={styles.sectionText}>
                ServicePro facilitates payments between customers and service providers. Payment
                processing fees may apply. Providers are responsible for their tax obligations.
              </Text>
            </View>
